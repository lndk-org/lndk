...
impl bitcoin_payment_instructions::hrn_resolution::HrnResolver for MockHrnResolver {
    ...
    fn resolve_lnurl<'a>(
        ...
        unimplemented!("LNURL resolution not supported in mock")
    }
    ...
    fn resolve_lnurl_to_invoice<'a>(
        ...
        unimplemented!("LNURL invoice resolution not supported in mock")
    }
}
...
async fn test_pay_offer_with_name_and_dns() {
    ...
    let handler = Arc::new(lndk::offers::handler::OfferHandler::with_hrn_resolver(
        None,
        None,
        None,
        mock_resolver,
