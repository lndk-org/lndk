    ...
    async fn test_set_feature_bit() {
        ...
        client_mock.expect_get_info().returning(|_| {
            Ok(tonic_lnd::lnrpc::GetInfoResponse {
                ...
                alias: Default::default(),
                best_header_timestamp: Default::default(),
                block_hash: Default::default(),
                block_height: Default::default(),
                chains: Default::default(),
                color: Default::default(),
                commit_hash: Default::default(),
                identity_pubkey: Default::default(),
                num_active_channels: Default::default(),
                num_inactive_channels: Default::default(),
                num_peers: Default::default(),
                num_pending_channels: Default::default(),
                require_htlc_interceptor: Default::default(),
                synced_to_chain: Default::default(),
                synced_to_graph: Default::default(),
